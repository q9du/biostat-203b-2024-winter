...
### Overall Grade: 97/130

### Quality of report: -11/10
...
-   Is the report clear (whole sentences, typos, grammar)? Do readers have a clear idea what's going on and how results are produced by just reading the report? Take some points off if the solutions are too succinct to grasp, or there are too many typos/grammar.
    ...
    **Should expand explanations in a few places e.g. Q3.7**
...
-   Q3 (20/20)
    ...
    **Should separate code chunks in 3.6 for readability**
...
-   Q5 (5/10)
    ...
    **Should include output from running these commands**
...
-   Are there enough commits (\>=5) in develop branch? Are commit messages clear? The commits should span out not clustered the day before deadline.
    ...
    **Commits all at submission deadline. Commits from another user.**
